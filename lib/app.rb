...
Dotenv.load
	...
	######Envoie un message avec le #bonjour_monde à 5 journalistes au hasard############
	def list_bonjour_monde 
		...
		arr_5 = array.sample(5)
		client = login_twitter

		for journalist in arr_5
			message = "#{journalist} \nVive les loutres cosmiques.\n #bonjour_monde"
